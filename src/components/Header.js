          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline: <a className='text-white' href="tel:+919440181136">+919440181136</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          ...
          <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links d-flex align-itmes-center justify-content-between">
                <div>
